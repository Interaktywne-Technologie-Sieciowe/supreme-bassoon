            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
                ...
                <div class="lg:col-span-1 space-y-8">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100 relative overflow-hidden">
                        ...
                        <div class="absolute top-0 left-0 w-2 h-full bg-gradient-to-b from-indigo-500 to-indigo-600">
                        </div>
                            ...
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-indigo-600 font-medium mb-4">{{
                                        selectedEvent.extendedProps.conferenceName }}</p>
                                </div>
                                ...
                                <button @click="handleBookmark(selectedEvent.extendedProps)"
                                    ...
                                    <div class="relative">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            :stroke-width="isBookmarked(selectedEvent.extendedProps) ? 0 : 2"
                                            viewBox="0 0 24 24">
